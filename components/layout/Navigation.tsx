...
export default function Navigation() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 bg-white/95 backdrop-blur-md shadow-sm z-50 transition-colors duration-300">
      <div className="container-custom">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <Link href="/courses" className="text-navy hover:text-primary transition-colors font-medium">
              Kursevi
            </Link>
            <Link href="/about" className="text-navy hover:text-primary transition-colors font-medium">
              O nama
            </Link>
            <Link href="/contact" className="text-navy hover:text-primary transition-colors font-medium">
              Kontakt
            </Link>
          </div>
          ...
          <div className="md:hidden flex items-center gap-3 relative z-50">
            ...
            >
              <span className={`block w-6 h-0.5 bg-navy transition-all duration-300 ${mobileMenuOpen ? 'rotate-45 translate-y-2' : ''}`}></span>
              <span className={`block w-6 h-0.5 bg-navy transition-all duration-300 ${mobileMenuOpen ? 'opacity-0' : ''}`}></span>
              <span className={`block w-6 h-0.5 bg-navy transition-all duration-300 ${mobileMenuOpen ? '-rotate-45 -translate-y-2' : ''}`}></span>
            </button>
          </div>
        </div>
